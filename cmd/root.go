/*
Copyright © 2024 NAME HERE <shephexd@gmail.com>
*/
package cmd
...
var rootCmd = &cobra.Command{
	Use:   "arf",
	Short: "The VPC Reachability Analyzer CLI tool",
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.arf.yaml)")
